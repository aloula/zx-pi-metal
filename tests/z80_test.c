...
int main(int argc, char **argv) {
    ...
    for (int i = 1; i < argc; i++) {
        if (strcmp(argv[i], "--zexdoc") == 0) {
            ...
            if (run_cpm_test("docs/z80/zexdoc.com") != 0) {
                printf("  File docs/z80/zexdoc.com not found.\n");
        ...
        if (strcmp(argv[i], "--zexall") == 0) {
            ...
            if (run_cpm_test("docs/z80/zexall.com") != 0) {
                printf("  File docs/z80/zexall.com not found.\n");
            }
            return 0;
        }
    }
